...
res_file='files/ctb_8_test_right_split_res.txt'
piece_joint_file='files/ctb_8_test_right_split_joint.pickle'
res_crf_file='files/ctb_8_test_right_split_res_crf.txt'

_test_file='files/CTB_binary2.txt'
_res_file='files/CTB_binary2_split.txt'
_piece_joint_file='files/CTB_binary2_piece_joint.pickle'#for piece joint crf src file
_res_crf_file='files/CTB_binary2_split_crf.txt'
##
is_test=True
##is_test=False
split_pos=['PU']#
